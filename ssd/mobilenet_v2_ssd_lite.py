...
def create_mobilenetv2_ssd_lite(num_classes: object, width_mult: object = 1.0, use_batch_norm: object = True, onnx_compatible: object = False,
                                is_test: object = False) -> object:
...
if __name__ == "__main__":
    create_mobilenetv2_ssd_lite(num_classes=21)
